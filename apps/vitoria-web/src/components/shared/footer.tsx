      ...
      <div className="border-b border-white/5 py-16 md:py-24">
        <div className="container mx-auto px-6 flex flex-col lg:flex-row items-center justify-between gap-10">
          <div className="text-center lg:text-left">
            ...
            <h2 className="text-4xl md:text-6xl font-bold tracking-normal leading-[1.1]">
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 md:gap-16">
          <div className="lg:col-span-2">
            <div className="flex flex-col mb-6">
              <div className="text-xl md:text-2xl font-bold tracking-normal uppercase leading-none">
                VITÓRIA
              </div>
              <div className="text-[10px] font-medium tracking-[0.2em] uppercase mt-1 text-white/40">
                TRANSPORTES
              </div>
            </div>
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#EC223D] mb-6">Executivo</h4>
          ...
          <div>
            <h4 className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#EC223D] mb-6">Corporativo</h4>
            <ul className="space-y-3 text-white/30 text-sm font-medium">
              <li>
      ...
      <div className="border-t border-white/5 py-8">
        <div className="container mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-white/20 text-[10px] font-medium uppercase tracking-widest">
            © {currentYear} Vitória Transportes. Rigor Operacional & Segurança.
          </p>
